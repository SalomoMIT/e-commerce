                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button id="btnSaveCourier" type="button" class="btn btn-md btn-custom display-flex align-items-center m-l-10">
                                        Simpan
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 col-md-6 m-b-30">
                                        <div class="shipping-address-box">
                                            <?php if ($address->address_type == 'billing'): ?>
                                                <label class="badge badge-secondary-light badge-shipping-address">
                                            ...
                                            <?php else: ?>
                                                <label class="badge badge-primary-light badge-shipping-address">
