...
if (in_array($_SERVER['REMOTE_ADDR'], $whitelist)) {
    header("Location: system-requirements.php?license_code=localhost-license" . "&purchase_code=1234");
    exit();
}
...
<head>
    ...
    <!-- Font-awesome CSS -->
    <link href="../assets/admin/vendor/fontawesome-6.7.2/css/all.min.css" rel="stylesheet"/>
                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    If you don't have a <b>license code</b>, please go to our helpdesk and generate your license code from the "Licenses" section. You can easily manage your licenses through this system and you can contact us by opening a ticket for any problems.
                                                    <br><br>
                                                    If you see the "Invalid License Code" error, please read this article:&nbsp;<a href="https://codingest.com/knowledge-base?content=120" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
                                            <div class="form-group text-center">
                                                <a href="https://codingest.com/" target="_blank" class="btn btn-success btn-custom">Go to Helpdesk</a>
                                            </div>
                                            <div class="form-group">
