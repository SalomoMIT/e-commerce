...
{
    $url = "https://codingest.com/api/verify-modesy-license?license_code=" . $license_code . "&domain=" . $current_url;
    $ch = curl_init();
    ...
    curl_close($ch);
    if (empty($response)) {
        $url = "http://codingest.com/api/verify-modesy-license?license_code=" . $license_code . "&domain=" . $current_url;
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        $response = curl_exec($ch);
