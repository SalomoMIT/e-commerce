                ...
                <div class="col-sm-12">
                    <div class="install-box">
                        ...
                        <div class="step-contents">
                            <div class="tab-1">
                                <h1 class="step-title">File/Folder Permissions</h1>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p><i class="fa fa-file"></i> .env</p>
                                        ...
                                        <p><i class="fa fa-folder-open"></i> uploads/support</p>
                                        <p><i class="fa fa-folder-open"></i> uploads/temp</p>
                                        <p><i class="fa fa-folder-open"></i> uploads/videos</p>
                                    </div>
                                    <div class="col-sm-6 text-right">
                                        <p><?php if (is_writable('../.env')) { ?><i class="fa fa-check color-success"></i><?php } else { ?><i class="fa fa-close color-danger"></i><?php } ?></p>
                                        <p><?php if (is_writable('../writable')) { ?><i class="fa fa-check color-success"></i><?php } else { ?><i class="fa fa-close color-danger"></i><?php } ?></p>
                                        ...
                                        <p><?php if (is_writable('../uploads/support')) { ?><i class="fa fa-check color-success"></i><?php } else { ?><i class="fa fa-close color-danger"></i><?php } ?></p>
