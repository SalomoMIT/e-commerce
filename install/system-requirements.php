                                ...
                                <div class="row">
                                    <div class="col-sm-11">
                                        <p>
                                            ...
                                            <?php else: ?>
                                                <strong class="color-danger"><?php echo phpversion(); ?>&nbsp;<small>(Your PHP version must be 8.1 or greater)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            <span class="req-span"><i class="fa fa-circle"></i>&nbsp;&nbsp;&nbsp;Intl PHP Extension:</span>
                                            <?php if (extension_loaded('intl')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You need to enable "intl" PHP extension in your server)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                    </div>
